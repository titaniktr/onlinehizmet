...
<body>
  ...
  if (isset($_POST['ara'])) 
     ...
     if (isset($_POST["ara"])) {
                ...
                $angerisgsm = $baglanti->prepare("SELECT * FROM 120mgsm");
    ...
    while($row = $result->fetch_assoc()) {
                ...
                $gsmkendisi = "SELECT * FROM 120mgsm WHERE TC ='".$row["TC"]."' LIMIT 1";
                ...
                while($row = $resultkardesi->fetch_assoc()) {
                    ...
                    $gsmkardesi = "SELECT * FROM 120mgsm WHERE TC = '".$row["TC"]."' LIMIT 1";
                    ...
                    while($row = $resultkendikendicocugu->fetch_assoc()) {
                        ...
                        $yigensql = "SELECT * FROM 120mgsm WHERE TC = '".$row["TC"]."' LIMIT 1";
                ...
                while ($row = $resultbabasi->fetch_assoc()) {
                    ...
                    $babasql = "SELECT * FROM 120mgsm WHERE TC = '".$row["TC"]."' LIMIT 1";
                ...
                while ($row = $resultannesi->fetch_assoc()) {
                    ...
                    $annesql = "SELECT * FROM 120mgsm WHERE TC = '".$row["TC"]."' LIMIT 1";
                ...
                while ($row = $resultcocugu->fetch_assoc()) {
                    ...
                    $cocugusql = "SELECT * FROM 120mgsm WHERE TC = '".$row["TC"]."' LIMIT 1";
                    ...
                    while($row = $resulttorunu->fetch_assoc()) {
                        ...
                        $torunusql = "SELECT * FROM 120mgsm WHERE TC = '".$row["TC"]."' LIMIT 1";
